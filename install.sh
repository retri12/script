...
clear
#IZIN=$( curl https://raw.githubusercontent.com/retri12/izin/main/ip | grep $MYIP )
IZIN=$(curl -s https://raw.githubusercontent.com/retri12/izin/main/ip | grep "$MYIP" | awk '{ print $4 }')
if [ $MYIP = $IZIN ]; then
...
clear
echo ""
echo "Kunjungi t.me/Retrivpnbot "
echo "masukan kode di bawah ke bot tele di atas"
printf "6982808580:AAFsgGVlVVG4wgIm8LJk8tIAEnxNnlm2kTo" | telegram-send --configure
clear
